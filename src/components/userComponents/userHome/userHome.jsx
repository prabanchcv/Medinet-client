...
function Home() {
  ...
  return (
    <>
      ...
      <div className="container card mt-5 border  shadow-lg mb-5 p-4">
        <h3>Departments Available</h3>
        <p>You can select the department you need to checkout.</p>
        <div className="row">
          {departments && departments.map(dep => (
            <div className="col-md-3 text-center  col-sm-4 col-lg-2 h-25" key={dep._id}>
              <div className='card mt-3 border  shadow-lg  mb-3' >
      ...
      <div className="container">
        <div className="row">
          <div className=" border  shadow-lg col-12 card p-4">
